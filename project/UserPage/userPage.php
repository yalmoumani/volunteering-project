...
<nav id="navbar" class="">
   ...
   <!-- this section edits name and image -->
    ...
    <!-- edit the details -->
    <?php 
 fetch('http://localhost/UserPage/editProfile.php')
  .then(response => response.json())
  .then(profile => {
    const editButtonClicked = <?php echo isset($_GET['edit']) ? 'true' : 'false'; ?>;
    if (editButtonClicked) {
      // Replace the div with the PHP code
      ...
      // ... Rest of the code for generating the profile HTML ...
